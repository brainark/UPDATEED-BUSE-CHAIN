 ...
 * @dev Advanced EPO with multiple wallet management strategies
 */
contract EnhancedBrainArkEPO is ReentrancyGuard, Ownable, Pausable {
    ...
    // BAK token funding wallet
    address public immutable bakFundingWallet;

    constructor(
        address _bakFundingWallet,
        address _ethWallet,
        address _usdtWallet,
        address _usdcWallet,
        address _bnbWallet,
        ...
        require(_bakFundingWallet != address(0), "Invalid BAK funding wallet");
        require(_defaultWallet != address(0), "Invalid default wallet");
        
        bakFundingWallet = _bakFundingWallet;
    ...
    /**
     * @notice Configure payment token with specific treasury wallet
     */
    function configurePaymentToken(
        ...
        emit PaymentTokenConfigured(token, enabled, priceUSD, treasuryWallet, block.timestamp);
    }
    ...
    function _transferBAKFromFunding(address to, uint256 amount) internal {
        ...
        // Transfer native BAK tokens from funding wallet
