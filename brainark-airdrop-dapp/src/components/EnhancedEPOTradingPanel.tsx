...
export default function EnhancedEPOTradingPanel() {
  ...
  // Auto-detect network on wallet connection
  useEffect(() => {
    if (currentNetworkName !== "unknown" && currentNetworkName !== "brainark") {
      setSelectedNetwork(currentNetworkName)
    }
  }, [currentNetworkName])
            ...
            {!isConnected ? (
              <div className="text-center py-8">
                ...
                <div className="text-sm text-gray-500">
                  Use the network switcher to connect and select your preferred payment method
                </div>
              </div>
            ) : (
              <div className="space-y-6">
                ...
                {currentNetworkName !== selectedNetwork && currentNetworkName !== 'unknown' && (
                  <div className="bg-blue-500/20 border border-blue-500/40 rounded-lg p-4 text-blue-400">
                    <div className="font-semibold mb-2">🌐 Cross-Chain Purchase</div>
                    <div className="text-sm">
                      You're on {currentNetworkName} network. You can pay with tokens from {selectedNetwork} network and receive BAK tokens on BrainArk Network.
                    </div>
                  </div>
                )}
